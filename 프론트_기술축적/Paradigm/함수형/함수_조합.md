함수 조합은 함수형 프로그래밍의 꽃인 함수형 프로그래밍

- 함수를 되도록 작게 만들기
- 상태를 변경하지 않아, 부수효과를 최소화 하기
- 순수 함수 늘리기
- 큰 로직을 고차함수로 만들고 세부 로직을 보조 함수로 완성하기
- 미뤄서 실행하기
- 기본 객체 이용하기
- 로직의 흐름은 단방향으로 흐르게 하기
- 작은 함수를 모아 큰 함수 만들기
...
const pipeline = function (...args: any[]) {
  return _.partial(_.reduce as any, args, (l: any, r: (arg0: any) => any) =>
    r(l)
  );
};
